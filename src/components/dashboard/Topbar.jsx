          ...
          <div className="relative">
            ...
            >
              <div className="
                ...
                group-hover:opacity-100
              " />
              <div className="relative rounded-2xl border border-white/10 shadow-lg shadow-blue-500/20 overflow-hidden w-10 h-10 flex items-center justify-center">
                <Avatar seed={user?.avatarSeed} size={42} className="rounded-2xl" />
              </div>
            </motion.button>
            <AvatarDropdown
              open={avatarOpen}
